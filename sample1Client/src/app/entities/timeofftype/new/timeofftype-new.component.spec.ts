...
import { ITimeofftype, TimeofftypeService, TimeofftypeNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('TimeofftypeNewComponent', () => {
  let component: TimeofftypeNewComponent;
  let fixture: ComponentFixture<TimeofftypeNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TimeofftypeNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [TimeofftypeService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(TimeofftypeNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [TimeofftypeNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [TimeofftypeService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
