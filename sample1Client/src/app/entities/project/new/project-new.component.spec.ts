...
import { IProject, ProjectService, ProjectNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [ProjectNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [ProjectService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [ProjectNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [ProjectService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
