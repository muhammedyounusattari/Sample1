...
import {
  ...
  TimesheetdetailsDetailsComponent,
  TimesheetdetailsListComponent,
  TimesheetdetailsNewComponent,
} from '../';

describe('TimesheetdetailsListComponent', () => {
  let fixture: ComponentFixture<TimesheetdetailsListComponent>;
  let component: TimesheetdetailsListComponent;
  let el: HTMLElement;

  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData: ITimesheetdetails[] = [
    {
      hours: 1,
      id: 1,
      notes: 'notes1',
      workdate: d,
      taskid: 1,
      taskDescriptiveField: 1,
      timeofftypeid: 1,
      timeofftypeDescriptiveField: 1,
      timesheetid: 1,
    ...
    },
    {
      ...
      workdate: d,
      taskid: 2,
      taskDescriptiveField: 2,
      timeofftypeid: 2,
      timeofftypeDescriptiveField: 2,
      timesheetid: 2,
      timesheetDescriptiveField: 2,
    },
  ];
  let data: ITimesheetdetails[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TimesheetdetailsListComponent, ListComponent],
        imports: [TestingModule],
        providers: [TimesheetdetailsService, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(TimesheetdetailsListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'timesheetdetails/:id', component: TimesheetdetailsDetailsComponent },
          ]),
        ],
        providers: [TimesheetdetailsService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/timesheetdetails/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
