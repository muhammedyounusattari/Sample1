...
import { ITimesheetdetails, TimesheetdetailsService, TimesheetdetailsNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('TimesheetdetailsNewComponent', () => {
  let component: TimesheetdetailsNewComponent;
  let fixture: ComponentFixture<TimesheetdetailsNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TimesheetdetailsNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [TimesheetdetailsService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(TimesheetdetailsNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [TimesheetdetailsNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [TimesheetdetailsService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
