...
describe('TimesheetListComponent', () => {
  ...
  let constData: ITimesheet[] = [
    ...
    },
    {
      ...
      periodstartingdate: d,
      timesheetstatusid: 2,
      timesheetstatusDescriptiveField: 2,
      userid: 2,
      usersDescriptiveField: 2,
    },
  ];
  let data: ITimesheet[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TimesheetListComponent, ListComponent],
        imports: [TestingModule],
        providers: [TimesheetService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'timesheet/:id', component: TimesheetDetailsComponent },
          ]),
        ],
        providers: [TimesheetService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/timesheet/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
