...
import { IAppConfiguration, AppConfigurationService, AppConfigurationNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('AppConfigurationNewComponent', () => {
  let component: AppConfigurationNewComponent;
  let fixture: ComponentFixture<AppConfigurationNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [AppConfigurationNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [AppConfigurationService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(AppConfigurationNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [AppConfigurationNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [AppConfigurationService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
