...
import {
  ...
  AppConfigurationDetailsComponent,
  AppConfigurationListComponent,
  AppConfigurationNewComponent,
} from '../';

describe('AppConfigurationListComponent', () => {
  let fixture: ComponentFixture<AppConfigurationListComponent>;
  let component: AppConfigurationListComponent;
  let el: HTMLElement;

  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData: IAppConfiguration[] = [
    {
      id: 1,
      type: 'type1',
      value: 'value1',
  ...
  let data: IAppConfiguration[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [AppConfigurationListComponent, ListComponent],
        imports: [TestingModule],
        providers: [AppConfigurationService, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(AppConfigurationListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'appconfiguration', component: AppConfigurationListComponent },
            { path: 'appconfiguration/:id', component: AppConfigurationDetailsComponent },
          ]),
        ],
        providers: [AppConfigurationService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/appconfiguration/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
