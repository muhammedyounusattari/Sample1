...
describe('AppConfigurationDetailsComponent', () => {
  let component: AppConfigurationDetailsComponent;
  let fixture: ComponentFixture<AppConfigurationDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [AppConfigurationDetailsComponent, DetailsComponent],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(AppConfigurationDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'appconfiguration', component: AppConfigurationDetailsComponent },
            { path: 'appconfiguration/:id', component: AppConfigurationListComponent },
          ]),
        ],
        providers: [AppConfigurationService],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/appconfiguration');
    });
  });
});
