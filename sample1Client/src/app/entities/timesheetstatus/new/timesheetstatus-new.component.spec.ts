...
import { ITimesheetstatus, TimesheetstatusService, TimesheetstatusNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('TimesheetstatusNewComponent', () => {
  let component: TimesheetstatusNewComponent;
  let fixture: ComponentFixture<TimesheetstatusNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TimesheetstatusNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [TimesheetstatusService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [TimesheetstatusNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [TimesheetstatusService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
